...
<html>
  <head>
    ...
    <title>FarmaVida - Panel de Administración</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="escritorio.php" class="logo">
          ...
          <span class="logo-mini"><i class="fa fa-medkit"></i> <b>FV</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><i class="fa fa-medkit"></i> <b>Farma</b>Vida</span>
        </a>
